        ...
        if (didOpen == YES){
            ...
            if (printer != nil){
                ...
                if (printerStatus.isReadyToPrint)
                    pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString:@"Ready to Print"];
                else if (printerStatus.isPaused)
                    pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Cannot print beacuse printer is paused"];
                else if (printerStatus.isHeadOpen)
                    pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Cannot print beacuse the printer head is open"];
                else if (printerStatus.isPaperOut)
                    pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Cannot print beacuse the paper is out"];
                else 
                    pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Cannot print"];
            }
        }
        else{
            pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Could not connect to printer"];
